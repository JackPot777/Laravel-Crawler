			...
			<div class="x_panel">
				...
				<div class="x_content" style="display: block;">
					<div class="table-responsive">
						...
						<table class="table table-striped jambo_table bulk_action">
							...
							<tbody>
								...
								<tr class="{{$i%2?'even':'odd'}} pointer">
									...
									<td class=" last">
									<div class="btn-group">
									  <a href="{{url('/objectives/url/get/'.$url->id)}}" class="btn btn-primary btn-xs">More</a>
									  ...
									  <ul class="dropdown-menu" role="menu">
										<li>
										<a href="{{url('/objectives/url/generate/'.$url->id)}}">Generated Urls</a>
										</li>
										<li class="divider"></li>
										<li>
										<a href="{{url('/objectives/url/softdelete/'.$url->id)}}">Soft Delete</a>
										</li>
									  </ul>
									</div>
									</td>
						...
						@else
							<div class="alert alert-success" role="alert">Empty url record.</div>
						@endif
					</div>
				</div>
				<center>
